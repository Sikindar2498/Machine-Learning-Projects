...
- For training the data and predicting the target, algorithms used are RandomForest Classifier and  XGBoost Classifier. 
...
-    It was observed that the maximum accuracy was obtained when we used Random Forest Classifier  91
-    67%  XGBoost Classifier also yielded an accuracy of 89.72%
